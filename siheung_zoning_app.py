...
# ✅ 제목
# -------------------------------------------------
st.title("🏢 시흥시 용도지역별 건축물 가능 여부 조회(테스트용)")

# ✅ ✅ ✅ 제목 아래 고정 안내문 추가
st.info("""
ℹ️ 본 시스템은 시흥시 도시계획조례에 근거하여 용도지역별 건축물 가능 여부를 간편 조회하기 위한 참고용 서비스로, 건축허가 및 인허가 가능 여부를 보장하지 않습니다. 정확한 사항은 반드시 해당 부서에 확인하시기 바랍니다.
""")
